...
@section('content')
<div class="hero-wrap js-fullheight" style="background-image: linear-gradient(90deg, rgba(2, 0, 36, 0.4) 0%, rgba(9, 9, 121, 0.4) 35%, rgba(0, 212, 255, 0.4) 100%), url('images/newbg2.jpg'); height: 1071px; " data-stellar-background-ratio="0.5">
  <div class="container h-100 d-flex align-items-center justify-content-center">
    <div class="text-white w-100">
      ...
      <form action="{{ route('job.search') }}" method="GET" class="search-job">
