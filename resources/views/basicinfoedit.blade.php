                                ...
                                <div class="form-group  row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            ...
                                            <input type="text"  class=" form-control datepicker" autocomplete="off" id="dob" name="birthday" placeholder="DOB"  value="{{ old('birthday', $logged_in_user->birthday ? \Carbon\Carbon::parse($logged-in_user->birthday)->format('d-m-Y') : '') }}"       >
